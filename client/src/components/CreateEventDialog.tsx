...
export function CreateEventDialog() {
  ...
  const createEventMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description:
          data.message ||
          "L'événement a été créé avec succès. Vos participants vont recevoir leurs invitations par email.",
        duration: 5000,
      });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const eventData = {
      ...
      participantEmails:
        participants.length > 0 ? participants.map((p) => p.email) : undefined,
      vehicles: vehicles.length > 0 ? vehicles : undefined,
      companyVehicleIds:
        selectedCompanyVehicles.length > 0 ? selectedCompanyVehicles : undefined,
    };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl" data-testid="dialog-create-event">
        <form onSubmit={handleSubmit}>
          ...
          {/* Formulaire complet avec Footer, caché pendant l'affichage du succès */}
          {!successMessage && (
            <>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem
                        value="single"
                        id="single"
                        data-testid="radio-event-single"
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem
                        value="recurring"
                        id="recurring"
                        data-testid="radio-event-recurring"
                      />
                  ...
                  {showParticipantForm && (
                    <div className="space-y-3 p-4 border rounded-lg bg-muted/50">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Les participants recevront une invitation par email avec un lien
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    if (e.target.checked) {
                                      ...
                                      setSelectedCompanyVehicles(
                                        selectedCompanyVehicles.filter(
                                          (id) => id !== vehicle.id
                                        )
                                      );
                                    }
